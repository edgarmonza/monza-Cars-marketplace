...
MISSING_CARS = {
    "porsche-930.jpg": ["Porsche_911_(classic)", "Porsche_911"],
    "audi-sport-quattro.jpg": ["Audi_Quattro", "Audi_Quattro_(original)"],
    "corvette-zr1.jpg": ["Chevrolet_Corvette_(C6)", "Chevrolet_Corvette_C6.R"],
}
...
def main():
    print("Downloading missing images with alternatives...")
    print("=" * 60)
