...
MISSING_CARS = {
    "subaru-22b.jpg": ["Subaru_Impreza", "Subaru_Impreza_(first_generation)"],
    "mercedes-190sl.jpg": ["Mercedes-Benz_SL-Class_(W121)", "Mercedes-Benz_W121"],
    "ford-boss-429.jpg": ["Ford_Mustang", "Ford_Mustang_(first_generation)"],
    "alfa-gta.jpg": ["Alfa_Romeo_Giulia", "Alfa_Romeo_105/115_Series_Coupés"],
    "datsun-240z.jpg": ["Nissan_S30", "Nissan_Z-car"],
}
...
def main():
    print("Downloading missing images with alternative articles...")
    print("=" * 60)
